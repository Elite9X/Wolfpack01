...
<head> central_region_b</h2>
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://www.pond5.com/stock-images/photos/item/132297270-old-bridge-through-river-fast-stream');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExZWpncnhhejc5Mm9seWg0Y3hwaGk3d3M2eDV1ZTZ1a292cWtoNnJvNyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/13QQ9ITdlbQGd2/giphy.gif"
              width="1000"
              height="1550"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      ...
      <h3></h3>
      <p><b>Instance Name:</b> $(hostname -Wolfpack)</p>
